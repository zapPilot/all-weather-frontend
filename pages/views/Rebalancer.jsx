                ...
                <Col xl={10} md={24} xs={24} align="center">
                    <Row gutter={[30, 20]} align="center">
                        <Col span={24} align="center">
                            <RebalanceChart rebalanceSuggestions={rebalanceSuggestions} netWorth={netWorth} windowWidth={windowWidth} />
                        </Col>
                        <div
                            style={{
                                display: "flex",
                        ...
                        >
                            <div style={{ position: "relative" }}>
                                ...
                                <div style={{ textAlign: "left", marginBottom: 10 }}>
                                    <strong style={{ color: "white", fontSize: 26 }}>Net Worth: ${netWorth.toFixed(2)}</strong>
                                </div>
                                <div style={{ textAlign: "left", marginBottom: 20 }}>
                                    <text style={{ color: "white", fontSize: 12, marginRight: 15 }}>
                                        Monthly Interest: ${(totalInterest / 12).toFixed(2)}
                                    </text>
                                    <text style={{ color: "white", fontSize: 12 }}>Portfolio APR: {portfolioApr.toFixed(2)}%</text>
                                </div>
