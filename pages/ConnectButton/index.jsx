import { ConnectButton, useActiveWalletChain, useActiveAccount } from "thirdweb/react";
...
export default function ConfiguredConnectButton() {
  ...
  const chainName = activeChain && activeChain.name ? activeChain.name.split(" ")[0] : "";
      ...
      detailsButton={{
        ...
        >
          <div className="flex items-center gap-2 p-1">
            <Image
              src={`/chainPicturesWebp/${chainName?chainName:"arbitrum"}.webp`}
              alt={chainName}
              height={16}
              width={16}
