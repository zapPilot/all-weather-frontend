...
const ERROR_CODES = {
  "0x46bcf4f0": "Insufficient funds for transaction",
  ...
  "2845524332303a207472616e7366657220616d6f756e74206578636565647320616c6c6f77616e6365":
    "ERC20: transfer amount exceeds allowance, please increase slippage tolerance and try again",
  "45524332303a207472616e7366657220616d6f756e7420657863656564732062616c616e6365":
    "ERC20: transfer amount exceeds balance, please increase slippage tolerance and try again",
 ...
 * @param {Error} error - The error object
 */
const logErrorToDiscord = async (error, address, chain, actionName) => {
...
export const handleTransactionError = async (
  ...
  await logErrorToDiscord(error, address, chain, actionName);

  // Show error notification if notification API is provided
  if (notificationAPI) {
    notificationAPI.error({
      message: title,
      description: `${userMessage} ${JSON.stringify(actionParams)}`,
    });
  }
